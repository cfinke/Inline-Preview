...
function inline_preview_enqueue( $hook ) {
	...
	wp_enqueue_script( 'inline-preview', plugins_url( 'inline-preview/inline-preview.js', __FILE__ ), array( 'jquery', 'jquery-ui-resizable' ), '4.3b1' );
	wp_enqueue_style( 'inline-preview-resizable', plugins_url( 'inline-preview/resizable.css', __FILE__ ), array(), '4.3b1' );
	wp_enqueue_style( 'inline-preview', plugins_url( 'inline-preview/inline-preview.css', __FILE__ ), array(), '4.3b1' );
